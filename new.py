...
async def execute_code(data: CodeExecutionRequest):
    ...
    try:
        ...
        for idx, res in enumerate(result.results):
            if hasattr(res, "png") and res.png:
                try:
                    ...
                    url = await upload_to_s3_direct_async(png_bytes, file_name, bucket_name)
                    if url:
        ...
        # Upload other /code files (excluding already-uploaded PNGs)
